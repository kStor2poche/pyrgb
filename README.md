# PyRGB 🎨
## A simple command-line rgb color converter written in python 3
...
This script can't :
- Brew cofee
- Spawn cats at your demand for your utmost pleasure
- Solve geopolitical conflicts around a raising thermonuclear war

## Usage 
Use `rgb.py -h` to get detailed help on how to use its features !
